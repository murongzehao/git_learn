...
void on_uart1_revc() {
    ...
    for( i = 0; i < COM1.RX_Cnt; i++) {
        printf("%02X" , (int)RX1_Buffer[i]);
    }
    printf("\n");
		
		printf("%02d-%02d-%02d-",(int)RX1_Buffer[3],(int)RX1_Buffer[4],(int)RX1_Buffer[5]);
		printf("%02d-%02d-%02d",(int)RX1_Buffer[7],(int)RX1_Buffer[8],(int)RX1_Buffer[9]);
}
